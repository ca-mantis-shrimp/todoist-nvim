-- [nfnl] Compiled from sync/init.fnl by https://github.com/Olical/nfnl, do not edit.
...
local function _1_(opts)
	...
	return utils.run_pipeline({
		data = opts,
		pipeline = { requests.create_project_sync_request, request_provider.post, requests.process_response },
	})
end
