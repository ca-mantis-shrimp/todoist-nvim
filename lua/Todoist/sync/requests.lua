-- [nfnl] Compiled from lua/Todoist/sync/requests.fnl by https://github.com/Olical/nfnl, do not edit.
...
M.create_project_sync_request = function(opts)
  return {url = M.url, headers = {Authorization = ("Bearer " .. opts.request.api_key)}, data = {sync_token = (opts.request.sync_token or "*"), resource_types = _G.vim.json.encode({"projects", "notes", "sections"}), timeout = 100000}}
end
