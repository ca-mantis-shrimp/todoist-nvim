...
local function _1_()
	local function _2_()
		local projects =
			{ { name = "inbox", id = 1, child_order = 1 }, { name = "child", id = 4, child_order = 2, parent_id = 1 } }
		...
		local expected_output = {
			{
				...
				id = 1,
				child_order = 1,
				comments = { { content = "test", id = 2, project_id = 1 } },
			...
			{ name = "child", id = 4, child_order = 2, parent_id = 1, sections = {}, comments = {}, children = {} },
		}
